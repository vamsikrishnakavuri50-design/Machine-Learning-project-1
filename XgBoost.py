...
print("==========================================")
print("       XGBOOST - PLACEMENT STATUS")
print("==========================================")
...
print(
    "Maximum Tree Depth:",
    xgboost_model.max_depth
)


print(
    "Subsample:",
    xgboost_model.subsample
)


print(
    "Column Sample by Tree:",
    xgboost_model.colsample_bytree
)


print(
    "Objective:",
    xgboost_model.objective
)


print(
    "Evaluation Metric:",
    xgboost_model.eval_metric
)
...
print("\n==========================================")
print("XGBOOST MODEL EXECUTION COMPLETED")
print("==========================================")